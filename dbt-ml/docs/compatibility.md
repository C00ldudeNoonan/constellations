...
Workstream E of the architecture-simplification program (issue #190). dbt-ml is
...
| --- | --- | --- |
| `DOCBT_PROFILES_DIR` env alias | Deprecated alias for `DBT_ML_PROFILES_DIR` | Only `DBT_ML_PROFILES_DIR` remains |
