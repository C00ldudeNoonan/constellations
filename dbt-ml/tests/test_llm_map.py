...
from dbt_ml.config.model import FieldConfig, LLMTransformConfig
from dbt_ml.llm_map import (
    LLMMapError,
    build_fields_spec,
    execute_map_item,
    resolve_llm_runtime,
...
def test_backend_and_node_share_the_execution_core() -> None:
    ...
    import dbt_ml.backends.llm_backend as backend_module
    import dbt_ml.llm_map as llm_map_module
