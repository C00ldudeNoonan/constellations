...
from dbt_ml.backends import BaseBackend, ExtractionResult
from dbt_ml.backends.base import BatchExtractionOutput
from dbt_ml.budget import BudgetGuard
from dbt_ml.config.loader import ConfigError
from dbt_ml.config.model import ExtractionConfig, ModelConfig
...
"""
    ...
    monkeypatch.setattr(
        "dbt_ml.sources.gcs.GCSDocumentSource.discover", _unexpected_discovery
    )
