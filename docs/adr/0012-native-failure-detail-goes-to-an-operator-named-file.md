...
- **Status:** accepted; amended by [ADR-0013](0013-a-debug-switch-owns-its-destination.md)
- **Date:** 2026-09-20
- **Prompted by:** #590
...
- Provider errors are not in the file. The provider layer sanitizes before
  ...
  separate decision about that layer. **Amended by ADR-0013:** that hatch
...
- The record filter is `exc_info is not None or level >= WARNING`. A new
  ...
  reach the file; the convention is now load-bearing. **Amended by ADR-0013:**
