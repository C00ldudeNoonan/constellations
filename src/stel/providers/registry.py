...
_GROUP_BASES: dict[str, str] = {
    "inference": "stel.inference_providers",
    "embedding": "stel.embedding_providers",
}
...
def _missing_provider_error(
    ...
    if incompatible is not None:
        ...
        return ProviderConfigurationError(
            ...
            f"this stel release requires v{PROVIDER_CONTRACT_VERSION}; "
...
class ProviderInventoryEntry:
    """Safe descriptor of one discovered provider for `stel providers list`."""
