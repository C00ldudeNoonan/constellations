...
from stel.compiler import ConfigError
from stel.config import load_project
from stel.config.model import ModelConfig, RetrievalTestConfig
from stel.retrieval_eval import (
    RetrievalEvalError,
...
def test_retrieval_tests_rejected_on_non_search_model() -> None:
    from stel.compiler import _validate_retrieval_tests
